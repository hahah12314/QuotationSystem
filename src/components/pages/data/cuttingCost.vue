<template>
    ...
    <el-form :model="dataDialogForm" :rules="rules" ref="ruleForm" label-width="120px">
      ...
      <el-form-item label="数割(M)" prop="numCut">
        <el-input v-model="dataDialogForm.numCut" autocomplete="off" style="width: 300px;"></el-input>
      </el-form-item>
      <el-form-item label="下料费" prop="cutFee">
        <el-input v-model="dataDialogForm.cutFee" autocomplete="off" style="width: 300px;"></el-input>
      </el-form-item>
      <el-form-item label="费用小计" prop="totalCutFee">
        <el-input v-model="dataDialogForm.totalCutFee" autocomplete="off" style="width: 300px;"></el-input>
      </el-form-item>
    </el-form>
    ...
    export default {
      ...
      methods: {
        ...
        async getDataList() {
          ...
          try {
            const res = await this.$http.get('/cutting-cost/list', params);
            console.log(res);
