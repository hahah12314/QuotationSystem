  ...
  <view class="container">
    <view class="uni-container">
      ...
      <view class="filter-bar">
        ...
        <uni-data-select v-model="filters.gender" :localdata="genderOptions" @change="onGenderChange" :clear="false"
          class="filter-select"></uni-data-select>
        <uni-data-select v-model="filters.level" :localdata="levelOptions" @change="onLevelChange" :clear="false"
          class="filter-select"></uni-data-select>
      ...
      <view class="popup-content" @click.stop>
        ...
        <view class="popup-body">
          ...
          <view class="popup-select">
            <text>性别</text>
            <uni-data-select v-model="editWorker.gender" :localdata="filteredGenderOptions" @change="onGenderChange"
              :clear="false"></uni-data-select>
          </view>
          <view class="popup-select">
            <text>级别</text>
            <uni-data-select v-model="editWorker.level" :localdata="filteredLevelOptions" @change="onLevelChange"
              :clear="false"></uni-data-select>
          </view>
    ...
    methods: {
      ...
      applyFilters() {
        ...
        this.filteredDataList = this.originalDataList.filter(worker => {
          ...
          const genderMatch = this.filters.gender === 0 || worker.gender === this.genderOptions[this.filters.gender]
            .text;
          const levelMatch = this.filters.level === 0 || worker.level === this.levelOptions[this.filters.level]
            .text;
