  ...
  <view class="container">
    ...
    <view class="uni-container">
      ...
      <view class="filter-bar">
        ...
        <uni-data-select v-model="filters.project" :localdata="projectOptions" @change="onProjectChange" :clear="false"
    ...
    methods: {
      ...
      applyFilters() {
        ...
        this.filteredDataList = this.originalDataList.filter(worker => {
          ...
          const projectMatch = this.filters.project === 0 || worker.processName === this.projectOptions[this.filters.project].text;
